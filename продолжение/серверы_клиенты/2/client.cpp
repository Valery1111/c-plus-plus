//client (messaging client-server)
...
public:
  ...
  void write(const messaging& msg)
  {
...
int main(int argc, char* argv[])
{
  try
  {
    if (argc != 3)
    {
      std::cerr << "Use as: client <host> <port>\n";
      return 1;
    }
    ...
    char line[messaging::max_body_length + 1];
    while (std::cin.getline(line, messaging::max_body_length + 1))
    {
      using namespace std;
      messaging msg;
